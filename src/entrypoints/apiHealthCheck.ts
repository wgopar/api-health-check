...
const healthCheckInputSchema = z.object({
  url: z
    ...
    .describe("HTTP(S) endpoint to verify (e.g., https://api.example.com/)"),
  method: z
    .enum(["HEAD", "GET"])
    .default("HEAD")
    .describe("HTTP method used for the probe (HEAD or GET)"),
  expectedStatus: z
    .coerce
    .number()
    .int()
  ...
  alertWebhookUrl: z
    ...
    .optional()
    .describe("Webhook invoked when the health check fails (e.g., https://example.com/my-webhook)"),
});
